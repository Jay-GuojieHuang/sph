    ...
    <div class="order-content">
        ...
        <table class="order-item" v-for="order in orderList.records" :key="order.id">
          ...
          <tbody>
            <tr v-for=" (item,index) in order.orderDetailList" :key="item.id">
              ...
              <td  v-show="index==0" :rowspan="order.orderDetailList.length" width="8%" class="center">{{order.consignee}}</td>
              <td   v-show="index==0" :rowspan="order.orderDetailList.length" width="13%" class="center">
                <ul class="unstyled">
              ...
              <td  v-show="index==0" :rowspan="order.orderDetailList.length" width="8%" class="center">
      ...
      <div class="choose-order">
        <!-- <div class="pagination">
         ...
         <PaginationCom :currPageNo="page" :pageSize="limit" :total="orderList.total" :continues="5" @getCurrPage="getCurrPage"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
