  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="width:80px; height:36px; margin-left: 10px;" @click="getCode">获取验证码</button>
      ...
      <div class="controls">
        <input name="isChecked" type="checkbox" :checked="agree" v-validate="{ required: true, 'tongyi': true}" :class="{ invalid: errors.has('isChecked')}" />
...
export default {
  ...
  methods: {
    ...
    async userRegister() {
      ...
      try {
        // console.log(phone, code, password, confirmPassword);
